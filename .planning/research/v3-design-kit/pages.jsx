...
// ── 2. MEETUPS — tall numbered rows with attendee/location stats ────────────
    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        {section.items.map((it, i) => {
          const num = section.items.length - i; // session #11 is newest
          ...
          return (
            <Wrap key={i} {...wrapProps}
              className={hasLink ? 'kni-tappable' : ''}
              style={{
                display: 'grid',
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{
                  ...
                  <span style={{ color: pgStyles.greenMute }}>{it.date}</span>

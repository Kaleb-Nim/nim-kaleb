...
// ── SYAI MEETUPS (11) ──────────────────────────────────────────────────────
// Each event has: num, date, title (topic only — "Meetup #N" is shown as a chip),
// desc (1-3 sentences), speakers (array of {name, role, linkedin}), images
// (array of src strings — use null for "drop photo here" placeholder).
//
// Placeholder content: real speaker names + LinkedIns to be pasted in by Kaleb.
// Drop event photos into assets/meetups/<event-id>/ and reference them here.
const SYAI_ITEMS = [
  {
  ...
  {
    num: 5, date: 'Apr 2025',
    title: 'AI Meets Ambition — Startup Showcase',
    desc: "Monthly meetup co-hosted with Cyber Youth Singapore at *SCAPE. Youth-led AI products went live in front of the room — health tools, smart productivity hacks, plus a few wonderfully silly demos — followed by unfiltered stories about the startup journey and a long, loud networking tail.",
    speakers: [
      { name: 'Speaker Name', role: 'Founder — Stepperwall',           linkedin: 'https://www.linkedin.com/in/' },
      { name: 'Speaker Name', role: 'Founder — Pimp My Toaster',       linkedin: 'https://www.linkedin.com/in/' },
      { name: 'Speaker Name', role: 'Founder — Revel (study tools)',   linkedin: 'https://www.linkedin.com/in/' },
      { name: 'CYS Rep',      role: 'Cyber Youth Singapore',           linkedin: 'https://www.linkedin.com/in/' },
    ],
    images: [
      '../../assets/meetups/apr-2025-hero.jpeg',
      '../../assets/meetups/apr-2025-startups.jpeg',
      '../../assets/meetups/apr-2025-network.jpeg',
    ],
  },
  {
    num: 4, date: 'Feb 2025',
